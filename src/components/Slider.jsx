...
const options = [
  {
    ...
    mobileBgImage: '/initiationmobile.webp',
    estado: '25 | 06 | 25',
    estadoAccion: 'Shop',
...
export default function InitiationCollection() {
  ...
  const option = options[0]; // Only one option: Initiation
  ...
  return (
    <div className="relative w-full h-[100vh] overflow-hidden bg-black">
      ...
      {/* Contenido centrado */}
      <div className="absolute top-[350px] md:top-[400px] left-0 right-0 transform -translate-y-1/2 h-full flex items-center justify-center">
        <div className="w-[20%] px-4 scale-110 z-10">
...
//   { id: 3, name: 'Initiation', bgImage: '/initiationslider.jpg', mobileBgImage: '/initiationmobile.webp', estado: '25 | 06 | 25', estadoAccion: 'Shop', link: '/collections/initiation' },

...
const OrderStep1 = () => {
  ...
  const generateOrder = async () => {
    ...
    try {
      ...
      console.log('Full order creation response:', JSON.stringify(orderResult, null, 2));

      const newOrderId = orderResult.order?._id || orderResult._id || orderResult.id || orderResult.orderId || orderResult.data?._id;
      if (!newOrderId) {
  ...
  const handlePayOrder = async () => {
    ...
    try {
      // Store order details in localStorage for redirection pages
      const orderDetails = {
        orderId,
        userInfo: {
          firstName: info.nombres,
          ...
          <>
            <div className="w-[100%] md:w-[70%] border-r border-r-[#D7D7D780]">
              ...
              {!showAdditionalInputs ? (
                ...
                <div className="mt-8 flex flex-col gap-4 items-center md:items-start info-section w-[90%] md:w-[100%]">
                ...
                {cart.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <div className="flex flex-col items-center">
                        <span className="font-medium text-xs text-[#A8A8A8]">
